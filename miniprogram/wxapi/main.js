...
module.exports = {
  ...
  yuyues: (data) => {
    return request('/yuyue/info', true, 'get', data)
  },
  yuyuebm: (data) => {
    return request('/yuyue/join', true, 'post', data)
  },
  yuyuecx: (id) => {
    return request('/user/yuyueJoin/info', true, 'get', {id})
  },
  yuyuexq: (data) => {
    return request('/yuyue/join/info', true, 'get',data)
  },
  yuyuedw:(data) => {
  ...
  yuyueteams:(data) =>{
    return request('/yuyue/info/team',true,'get',data)
  },
  tpxq:(data) => {
    return request('/vote/info',true,'get',data)
  },
  tpdw:(data) =>{
    return request('/vote/vote',true ,'post',data)
  },
  tpjl:(data) => {
    return request('/vote/vote/info',true, 'get',data)
  },
  tpcs:(data) => {
